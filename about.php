...
?>
	...
	<div class="card shadow--3dp">
        ...
        <p>The show is a conversation between 3 friends that wind each other up and joke around. 
        Whilst we discuss video games across all platforms (except for THOSE ones).</p>
        ...
        Generally speaking we will stay on topic but there's a very good chance we will go off on long tangents. If for any reason you do not wish to join us on these journeys (<i>regulars know how these go</i>) 
